        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
            {id == "bag" &&
                <div ><img src={bag} style={{ display: "flex",height:"300px",marginLeft:"180px" }} />
                    ...
                    <button style={{ marginLeft:"280px",marginTop:"20px",fontSize:"20px" }} onClick={() => setIsOpen(true)} >Add to Cart</button>
            ...
            {id == "pen" && <div><img src={pen} style={{ display: "flex",height:"300px",marginLeft:"300px" }} />
                ...
                <button style={{ marginLeft:"480px",marginTop:"20px",fontSize:"20px" }} onClick={() => setIsOpen(true)}>Add to Cart</button>
                <AddCart open={isOpen} onClose={() => setIsOpen(false)} />
                </div>}
            {id == "copy" && <div><img src={copy} style={{ display: "flex",height:"300px",marginLeft:"300px" }} />
                ...
                <button style={{ marginLeft:"400px",marginTop:"20px",fontSize:"20px" }} onClick={() => setIsOpen(true)} >Add to Cart</button>
            ...
            {id == "stand" && <div><img src={stand} style={{ display: "flex",height:"300px",marginLeft:"100px" }} />
                ...
                <button style={{ marginLeft:"210px",marginTop:"20px",fontSize:"20px" }} onClick={() => setIsOpen(true)}>Add to Cart</button>
                <AddCart open={isOpen} onClose={() => setIsOpen(false)} /></div>}
